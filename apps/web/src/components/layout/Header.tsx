      ...
      <div className="mx-auto flex w-full max-w-[1680px] items-center justify-between gap-3 px-4 py-4 lg:px-[120px]">
        <div className="flex min-w-0 flex-1 items-center gap-3 lg:gap-6">
          ...
          <div className="relative min-w-0 flex-1">
            <form className="relative w-full max-w-[544px]" onSubmit={onSearch}>
              <input
                value={searchQuery}
              ...
              <button
                type="submit"
                aria-label="Search"
                className={`absolute top-1/2 -translate-y-1/2 ${dir === 'rtl' ? 'right-4' : 'left-4'}`}
              >
        ...
        <nav className="hidden items-center gap-6 px-28 lg:flex">
        ...
        <div className="flex shrink-0 items-center gap-3">
          ...
          <a
            ...
            className="hidden h-[50px] items-center justify-center rounded-[5px] bg-[#004FCE] px-5 text-sm font-semibold text-white lg:inline-flex"
          >
            {t.callForInfo}
          </a>
          ...
          >
            <span aria-hidden="true" className="inline-flex flex-col gap-[3px]">
              <span className="block h-[2px] w-5 bg-[#333]" />
              <span className="block h-[2px] w-5 bg-[#333]" />
              <span className="block h-[2px] w-5 bg-[#333]" />
            </span>
          </button>
